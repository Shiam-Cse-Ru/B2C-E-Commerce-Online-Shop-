					...
					<div class = "panel panel-well span6 alert alert-success">	
                        <form method = "POST" >
                            ...
                            <label for="message"><span>message</span>
                                <textarea id="message" style = "resize:none;" name = "message" cols="30" rows="10" required=""></textarea>
                            </label>
						...
						
						{
							...
							$message = $_POST['message'];
										...
										mysqli_query($dbcon,"insert into messages(name,Email,message) VALUES('$name','$Email','$message')");
