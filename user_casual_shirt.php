            ...
            <div id="content">
                <div class="hero-unit-table"> 
                    ...
                    <div id="body">
                        ...
                        <ul class="thumbnails">
                            <?php
                            $query = mysqli_query($dbcon,"select * from tb_products WHERE category = 'Casual_Shirt'") or die(mysqli_error());
                            while ($row = mysqli_fetch_array($query)) {
                                ...
                                <li class="span3">
                                    ...
                                    if (isset($_POST['order'])) {
                                        ...
                                        mysqli_query($dbcon,"insert into order_details (memberID,qty,productID,price,total,status) values('$member_id','$quantity','$product_id','$price','$total','Pending')") or die(mysqli_query());
                                     /*    header('location:user_wines.php'); */
                                    
										?>
												<script>
																window.location = 'user_casual_shirt.php';				
																</script>
										<?php
                                    }
                                    ?>
