<div class="modal fade" id="joke" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            ...
                            if (isset($_POST['go'])) {
                                ...
                                $p = $_POST['p'];
										...
										$query = mysqli_query($dbcon,"select * from tb_user where username= '$un'") or die (mysqli_error());
									...
									<?php
									 ...
									 mysqli_query($dbcon,"insert into tb_user (firstname,lastname,username,password) values('$fn','$ln','$un','$p')") or die(mysqli_error());
									?>
									<script>
