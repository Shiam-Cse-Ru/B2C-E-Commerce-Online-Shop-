                        ...
                        <div class="hero-unit-table">   
                          <div class="hero-unit-table">   
                            ...
                            <form class="form-horizontal" method="post">
                                ...
                                <hr>
                                <?php
                                $query = mysqli_query($dbcon,"select * from tb_user where user_id='$get_id'") or die(mysqli_error());
                            ...
                            if (isset($_POST['update'])) {
                                ...
                                mysqli_query($dbcon,"update tb_user set firstname='$fn', lastname='$ln' , username='$un' , password='$p'") or die(mysqli_error());
