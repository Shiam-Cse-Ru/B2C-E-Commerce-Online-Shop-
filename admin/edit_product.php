                    ...
                    <div class="col-md-5 well">
                        <div class="hero-unit-table">   
                          <div class="hero-unit-table">   
                            ...
                            $query = mysqli_query($dbcon,"select * from tb_products where productID='$get_id'") or die(mysqli_error());
...
//
                                ...
                                mysqli_query($dbcon,"update tb_products set name='$name',description='$description',category='$category',originated='$originated',price='$price',quantity='$quantity',location='$location' where productID='$get_id'") or die(mysqli_query());
